    ...
    <section className="bg-muted border-y border-border/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="relative w-full overflow-hidden flex items-center h-12">
          {/* Fade overlays */}
          <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#0F1629] to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#0F1629] to-transparent z-10" />
