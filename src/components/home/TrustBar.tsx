...
export const TrustBar = () => {
  ...
  return (
    <section ref={revealRef} className="bg-muted border-y border-border/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        {/* Row 1: Metrics */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-10 reveal">
        ...
        <div className="relative w-full overflow-hidden flex items-center h-12 reveal reveal-delay-2">
          {/* Fade overlays */}
